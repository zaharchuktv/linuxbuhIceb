/*$Id: l_uosopp_v.c,v 1.20 2011-02-21 07:35:54 sasa Exp $*/
/*27.03.2008	28.12.2005	Белых А.И.	l_uosopp_v.c
...
void  uosopp_v_e_knopka(GtkWidget *widget,class l_uosopp_v_data *data);
void  uosopp_radio1_0(GtkWidget *widget,class l_uosopp_v_data *data);
void  uosopp_radio1_1(GtkWidget *widget,class l_uosopp_v_data *data);
void  uosopp_radio1_2(GtkWidget *widget,class l_uosopp_v_data *data);
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(l_uosopp_v_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton1[0]), "clicked",GTK_SIGNAL_FUNC(uosopp_radio1_0),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton1[1]), "clicked",GTK_SIGNAL_FUNC(uosopp_radio1_1),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton1[2]), "clicked",GTK_SIGNAL_FUNC(uosopp_radio1_2),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton2[0]), "clicked",GTK_SIGNAL_FUNC(uosopp_radio2_0),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton2[1]), "clicked",GTK_SIGNAL_FUNC(uosopp_radio2_1),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD]), "activate",GTK_SIGNAL_FUNC(l_uosopp_v_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAIM]), "activate",GTK_SIGNAL_FUNC(l_uosopp_v_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(l_uosopp_v_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(l_uosopp_v_v_knopka),&data);
...
int knop=GPOINTER_TO_INT(gtk_object_get_user_data(GTK_OBJECT(widget)));
//g_print("l_uosopp_v_v_knopka knop=%d\n",knop);
...
//g_print("l_uosopp_v_v_vvod enter=%d\n",enter);
...
//printf("uosopp_v_zap vido=%d prov=%d\n",data->rk.vido,data->rk.prov);
...
sprintf(strsql,"update Prov set oper='%s' where oper='%s' and tz=1 and kto='%s'",nkod,skod,gettext("УОС"));
