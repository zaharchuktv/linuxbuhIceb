/*$Id: iceb_l_grupmat_v.c,v 1.20 2011-01-13 13:49:59 sasa Exp $*/
/*11.11.2008	05.05.2004	Белых А.И.	iceb_l_grupmat_v.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(grupmat_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD]), "activate",GTK_SIGNAL_FUNC(grupmat_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAIM]), "activate",GTK_SIGNAL_FUNC(grupmat_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[PFK2]),"clicked",GTK_SIGNAL_FUNC(grupmat_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[PFK10]),"clicked",GTK_SIGNAL_FUNC(grupmat_v_knopka),&data);
...
/*g_print("grupmat_v_knopka knop=%d\n",*knop);*/
...
//g_print("grupmat_v_vvod enter=%d\n",enter);
