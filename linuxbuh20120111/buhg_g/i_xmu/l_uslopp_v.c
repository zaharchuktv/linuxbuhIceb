/*$Id: l_uslopp_v.c,v 1.22 2011-02-21 07:35:54 sasa Exp $*/
/*12.11.2008	18.07.2005	Белых А.И.	l_uslopp_v.c
...
void  uslopp_radio1_0(GtkWidget *widget,class l_uslopp_v_data *data);
void  uslopp_radio1_1(GtkWidget *widget,class l_uslopp_v_data *data);
void  uslopp_radio2_0(GtkWidget *widget,class l_uslopp_v_data *data);
void  uslopp_radio2_1(GtkWidget *widget,class l_uslopp_v_data *data);
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(l_uslopp_v_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton1[0]), "clicked",GTK_SIGNAL_FUNC(uslopp_radio1_0),&data);
if(data.rk.vido == 0)
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton1[1]), "clicked",GTK_SIGNAL_FUNC(uslopp_radio1_1),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton2[0]), "clicked",GTK_SIGNAL_FUNC(uslopp_radio2_0),&data);
if(data.rk.prov == 0)
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton2[1]), "clicked",GTK_SIGNAL_FUNC(uslopp_radio2_1),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD]), "activate",GTK_SIGNAL_FUNC(l_uslopp_v_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAIM]), "activate",GTK_SIGNAL_FUNC(l_uslopp_v_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_SHET]),"clicked",GTK_SIGNAL_FUNC(uslopp_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_SHET]), "activate",GTK_SIGNAL_FUNC(l_uslopp_v_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(l_uslopp_v_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(l_uslopp_v_v_knopka),&data);
...
//g_print("l_uslopp_v_v_vvod enter=%d\n",enter);
...
printf("uslopp_v_zap vido=%d prov=%d\n",data->rk.vido,data->rk.prov);
...
sprintf(strsql,"update Prov set oper='%s' where oper='%s' and tz=1 and kto='%s'",nkod,skod,gettext("УСЛ"));
