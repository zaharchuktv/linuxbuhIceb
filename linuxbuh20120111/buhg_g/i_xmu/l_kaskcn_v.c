/*$Id: l_kaskcn_v.c,v 1.14 2011-02-21 07:35:52 sasa Exp $*/
/*29.09.2006	29.09.2006	Белых А.И.	l_kaskcn_v.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(l_kaskcn_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD]), "activate",GTK_SIGNAL_FUNC(l_kaskcn_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAIM]), "activate",GTK_SIGNAL_FUNC(l_kaskcn_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[PFK2]),"clicked",GTK_SIGNAL_FUNC(l_kaskcn_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[PFK10]),"clicked",GTK_SIGNAL_FUNC(l_kaskcn_v_knopka),&data);
...
//g_print("l_kaskcn_v_knopka knop=%d\n",knop);
...
//g_print("l_kaskcn_v_vvod enter=%d\n",enter);
