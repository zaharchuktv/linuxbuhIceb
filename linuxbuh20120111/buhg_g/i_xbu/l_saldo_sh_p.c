/*$Id: l_saldo_sh_p.c,v 1.11 2011-02-21 07:35:53 sasa Exp $*/
/*31.12.2003	31.12.2003	Белых А.И.	l_saldo_sh_p.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(saldo_sh_p_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_GOD]), "activate",GTK_SIGNAL_FUNC(saldo_sh_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_SHET]),"clicked",GTK_SIGNAL_FUNC(l_saldo_shp_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_SHET]), "activate",GTK_SIGNAL_FUNC(saldo_sh_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DEBET]), "activate",GTK_SIGNAL_FUNC(saldo_sh_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KREDIT]), "activate",GTK_SIGNAL_FUNC(saldo_sh_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(saldo_sh_p_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]),"clicked",GTK_SIGNAL_FUNC(saldo_sh_p_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(saldo_sh_p_knopka),&data);
...
//g_print("saldo_sh_p_vvod enter=%d\n",enter);
