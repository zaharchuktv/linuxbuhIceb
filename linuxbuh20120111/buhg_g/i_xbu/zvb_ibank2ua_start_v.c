/*$Id: zvb_ibank2ua_start_v.c,v 1.6 2011-02-21 07:36:00 sasa Exp $*/
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(zvb_ibank2ua_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATPP]),"clicked",GTK_SIGNAL_FUNC(zvb_ibank2ua_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATPP]), "activate",GTK_SIGNAL_FUNC(zvb_ibank2ua_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NOMERPP]), "activate",GTK_SIGNAL_FUNC(zvb_ibank2ua_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_MESZP]),"activate",GTK_SIGNAL_FUNC(zvb_ibank2ua_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOMENT]), "activate",GTK_SIGNAL_FUNC(zvb_ibank2ua_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(zvb_ibank2ua_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(zvb_ibank2ua_v_knopka),&data);
