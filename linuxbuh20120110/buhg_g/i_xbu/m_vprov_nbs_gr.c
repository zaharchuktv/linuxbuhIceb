/*$Id: m_vprov_nbs_gr.c,v 1.16 2011-02-21 07:35:55 sasa Exp $*/
/*18.11.2008	05.01.2004	Белых А.И.	m_vprov_nbs_gr.c
...
void    vprov_nbs_gr_zp(class vprov_nbs_gr_data *data);
void   vregp(GtkWidget*);

extern SQL_baza	bd;
extern char *name_system;

void  m_vprov_nbs_gr(char *shet)
{
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DEBET]), "activate",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KREDIT]), "activate",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATA]), "activate",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOMENT]), "activate",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_vvod),&data);
...
gtk_box_pack_start (GTK_BOX (hbox5), data.entry[E_GRUPA], TRUE, TRUE, 0);
gtk_signal_connect(GTK_OBJECT (data.entry[E_GRUPA]), "activate",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK3]),"clicked",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]),"clicked",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK5]),"clicked",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(vprov_nbs_gr_v_knopka),&data);
