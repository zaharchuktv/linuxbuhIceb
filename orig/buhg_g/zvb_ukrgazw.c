/*$Id: zvb_ukrgazw.c,v 1.5 2011-02-21 07:36:00 sasa Exp $*/
/*22.10.2009	22.10.2009	Белых А.И.	zvb_ukrgazw.c
...
while(cur.read_cursor(&row) != 0)
 {
  ...
  zvb_ukrgaz_strw(++nomer_zap,fio,kartshet,suma,inn,row[1],ff_dbf_tmp,ffr);
