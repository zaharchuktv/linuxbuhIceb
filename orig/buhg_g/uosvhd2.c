/*$Id: uosvhd2.c,v 1.15 2011-08-29 07:13:44 sasa Exp $*/
/*10.08.2011	29.10.2007	Белых А.И.	uosvhd2.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(uosvhd2_m_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATADOK]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATADOK]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_NOMDOK]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NOMDOK]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_PODR]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_PODR]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_MAT_OT]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_MAT_OT]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KONTR]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KONTR]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_OSNOV]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DOVER]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_SHEREZ]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATA_VD]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATA_VD]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_NOMNALNAK]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_tooltips_set_tip(tooltips_enter[E_NOMNALNAK],data.knopka_enter[E_NOMNALNAK],gettext("Выбор даты"),NULL);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NOMNALNAK]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATA_VNN]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATA_VNN]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATA_OPL]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATA_OPL]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_FOROP]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_FOROP]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
data.entry[E_VID_DOG] = gtk_entry_new_with_max_length (59);
gtk_box_pack_start (GTK_BOX (hbox[E_VID_DOG]), data.entry[E_VID_DOG], TRUE, TRUE,1);
gtk_signal_connect(GTK_OBJECT (data.entry[E_VID_DOG]), "activate",GTK_SIGNAL_FUNC(uosvhd2_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_m_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK3]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_m_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(uosvhd2_m_v_knopka),&data);
