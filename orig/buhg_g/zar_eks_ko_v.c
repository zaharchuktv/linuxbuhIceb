/*$Id: zar_eks_ko_v.c,v 1.13 2011-02-21 07:35:59 sasa Exp $*/
/*15.09.2009	20.10.2006	Белых А.И.	zar_eks_ko_v.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(zar_eks_ko_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KASSA]),"clicked",GTK_SIGNAL_FUNC(zar_eks_ko_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KASSA]), "activate",GTK_SIGNAL_FUNC(zar_eks_ko_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATA]),"clicked",GTK_SIGNAL_FUNC(zar_eks_ko_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATA]), "activate",GTK_SIGNAL_FUNC(zar_eks_ko_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KODOP]),"clicked",GTK_SIGNAL_FUNC(zar_eks_ko_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KODOP]), "activate",GTK_SIGNAL_FUNC(zar_eks_ko_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[PFK2]),"clicked",GTK_SIGNAL_FUNC(zar_eks_ko_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[PFK10]),"clicked",GTK_SIGNAL_FUNC(zar_eks_ko_v_knopka),&data);
