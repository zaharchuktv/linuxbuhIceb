/*$Id: l_uosopp.c,v 1.23 2011-02-21 07:35:54 sasa Exp $*/
/*12.11.2009	17.07.2005	Белых А.И.	l_uosopp.c
...
{
iceb_u_str repl;
//printf("uosopp_key_press keyval=%d state=%d\n",event->keyval,event->state);
...
printf("l_uosoppadd_columns end\n");
...
{
//printf("l_uosoppv_row\n");
//printf("l_uosoppv_row корректировка\n");
