/*$Id: l_xrnngvn_p.c,v 1.6 2011-02-21 07:35:54 sasa Exp $*/
/*14.04.2008	14.04.2004	Белых А.И.	l_xrnngvn_p.c
...
//g_print("l_xrnngvn_p_knopka knop=%d\n",knop);
...
//g_print("l_xrnngvn_p_vvod enter=%d\n",enter);
