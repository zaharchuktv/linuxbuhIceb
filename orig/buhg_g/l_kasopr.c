/*$Id: l_kasopr.c,v 1.21 2011-02-21 07:35:52 sasa Exp $*/
/*11.11.2009	18.01.2006	Белых А.И.	l_kasopr.c
...
sprintf(bros,"%s %s",name_system,gettext("Список расходных операций"));
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(kasopr_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]), "clicked",GTK_SIGNAL_FUNC(kasopr_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[SFK2]), "clicked",GTK_SIGNAL_FUNC(kasopr_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK3]), "clicked",GTK_SIGNAL_FUNC(kasopr_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[SFK3]), "clicked",GTK_SIGNAL_FUNC(kasopr_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]), "clicked",GTK_SIGNAL_FUNC(kasopr_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK5]), "clicked",GTK_SIGNAL_FUNC(kasopr_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]), "clicked",GTK_SIGNAL_FUNC(kasopr_knopka),&data);
...
{
iceb_u_str repl;
//printf("kasopr_key_press keyval=%d state=%d\n",event->keyval,event->state);
...
{
//printf("kasopr_v_row\n");
//printf("kasopr_v_row корректировка\n");
...
iceb_u_zagolov(gettext("Список расходных операций"),0,0,0,0,0,0,organ,ff);
