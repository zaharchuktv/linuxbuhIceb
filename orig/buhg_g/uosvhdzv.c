/*$Id: uosvhdzv.c,v 1.12 2011-02-21 07:35:58 sasa Exp $*/
/*28.10.2007	19.10.2007	Белых А.И.	uosvhdzv.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(uosvhdzv_m_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATADOK]),"clicked",GTK_SIGNAL_FUNC(uosvhdzv_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATADOK]), "activate",GTK_SIGNAL_FUNC(uosvhdzv_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_NOMDOK]),"clicked",GTK_SIGNAL_FUNC(uosvhdzv_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NOMDOK]), "activate",GTK_SIGNAL_FUNC(uosvhdzv_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_PODR]),"clicked",GTK_SIGNAL_FUNC(uosvhdzv_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_PODR]), "activate",GTK_SIGNAL_FUNC(uosvhdzv_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_MAT_OT]),"clicked",GTK_SIGNAL_FUNC(uosvhdzv_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_MAT_OT]), "activate",GTK_SIGNAL_FUNC(uosvhdzv_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_OSNOV]), "activate",GTK_SIGNAL_FUNC(uosvhdzv_m_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(uosvhdzv_m_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK3]),"clicked",GTK_SIGNAL_FUNC(uosvhdzv_m_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(uosvhdzv_m_v_knopka),&data);
