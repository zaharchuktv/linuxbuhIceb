/*$Id: l_uosmo_v.c,v 1.17 2011-02-21 07:35:54 sasa Exp $*/
/*20.11.2007	18.10.2007	Белых А.И.	l_uosmo_v.c
...
//g_print("l_uosmo_v_knopka knop=%d\n",knop);
...
//g_print("l_uosmo_v_vvod enter=%d\n",enter);
