/*$Id: l_uosgrnu_p.c,v 1.8 2011-02-21 07:35:53 sasa Exp $*/
/*18.10.2007	18.10.2007	Белых А.И.	l_uosgrnu_p.c
...
//g_print("l_uosgrnu_p_knopka knop=%d\n",knop);
...
//g_print("l_uosgrnu_p_vvod enter=%d\n",enter);
