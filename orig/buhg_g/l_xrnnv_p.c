/*$Id: l_xrnnv_p.c,v 1.9 2011-02-21 07:35:54 sasa Exp $*/
/*07.05.2008	07.04.2008	Белых А.И.	l_xrnnv_p.c
Поиск
*/
#include <stdlib.h>
#include <unistd.h>
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(l_xrnnv_p_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATAN]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATAN]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATAK]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATAK]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NNN]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NOMDOK]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_INN]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_NAIM_KONTR]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAIM_KONTR]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOMENT]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KOD_GR]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD_GR]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KOD_OP]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD_OP]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_PODS]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_PODS]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
gtk_entry_set_text(GTK_ENTRY(data.entry[E_PODS]),data.rk->kodop.ravno_toutf());
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_VIDDOK]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_VIDDOK]), "activate",GTK_SIGNAL_FUNC(l_xrnnv_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(l_xrnnv_p_knopka),&data);
...
int knop=GPOINTER_TO_INT(gtk_object_get_user_data(GTK_OBJECT(widget)));
//g_print("l_xrnnv_p_knopka knop=%d\n",knop);
...
//g_print("l_xrnnv_p_vvod enter=%d\n",enter);
