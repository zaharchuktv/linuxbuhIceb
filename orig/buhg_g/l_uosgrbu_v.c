/*$Id: l_uosgrbu_v.c,v 1.15 2011-03-28 06:55:46 sasa Exp $*/
/*13.04.2009	18.10.2007	Белых А.И.	l_uosgrbu_v.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(l_uosgrbu_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD]), "activate",GTK_SIGNAL_FUNC(l_uosgrbu_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAIM]), "activate",GTK_SIGNAL_FUNC(l_uosgrbu_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_PROC]), "activate",GTK_SIGNAL_FUNC(l_uosgrbu_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[PFK2]),"clicked",GTK_SIGNAL_FUNC(l_uosgrbu_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[PFK10]),"clicked",GTK_SIGNAL_FUNC(l_uosgrbu_v_knopka),&data);
...
//g_print("l_uosgrbu_v_knopka knop=%d\n",knop);
...
//g_print("l_uosgrbu_v_vvod enter=%d\n",enter);
