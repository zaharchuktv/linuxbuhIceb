/*$Id: l_zargni.c,v 1.16 2011-02-21 07:35:55 sasa Exp $*/
/*12.11.2009	23.06.2006	Белых А.И.	l_zargni.c
...
class l_zargni_data *data)
{
//printf("l_zargni_v_row\n");
//printf("l_zargni_v_row корректировка\n");
if(data->metka_rr == 0)
 {
  gtk_signal_emit_by_name(GTK_OBJECT(data->knopka[SFK2]),"clicked");
  return;
...
iceb_u_zagolov(gettext("Список городов налоговых инспекций"),0,0,0,0,0,0,organ,ff);
