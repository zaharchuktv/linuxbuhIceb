/*$Id: l_zarzvan.c,v 1.16 2011-02-21 07:35:55 sasa Exp $*/
/*14.11.2009	21.06.2006	Белых А.И.	l_zarzvan.c
...
class l_zarzvan_data *data)
{
//printf("l_zarzvan_v_row\n");
//printf("l_zarzvan_v_row корректировка\n");
if(data->metka_rr == 0)
 {
  gtk_signal_emit_by_name(GTK_OBJECT(data->knopka[SFK2]),"clicked");
  return;
...
iceb_u_zagolov(gettext("Список званий"),0,0,0,0,0,0,organ,ff);
