/*$Id: l_f1dfz1_v.c,v 1.14 2011-05-06 08:37:47 sasa Exp $*/
/*09.01.2007	09.01.2007	Белых А.И.	l_f1dfz1_v.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(l_f1dfz1_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_FIO]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_INN]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_VIP_DOH]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_VIP_NAL]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAH_DOH]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAH_NAL]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
data.entry[E_OZ_DOH] = gtk_entry_new_with_max_length (8);
gtk_box_pack_start (GTK_BOX (hbox[E_OZ_DOH]), data.entry[E_OZ_DOH], TRUE, TRUE, 0);
gtk_signal_connect(GTK_OBJECT (data.entry[E_OZ_DOH]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATA_PNR]),"clicked",GTK_SIGNAL_FUNC(l_f1dfz1_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATA_PNR]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATA_USR]),"clicked",GTK_SIGNAL_FUNC(l_f1dfz1_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATA_USR]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
data.entry[E_LGOTA] = gtk_entry_new_with_max_length (4);
gtk_box_pack_start (GTK_BOX (hbox[E_LGOTA]), data.entry[E_LGOTA], TRUE, TRUE, 0);
gtk_signal_connect(GTK_OBJECT (data.entry[E_LGOTA]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_PRIZNAK]), "activate",GTK_SIGNAL_FUNC(l_f1dfz1_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(l_f1dfz1_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(l_f1dfz1_v_knopka),&data);
...
int knop=GPOINTER_TO_INT(gtk_object_get_user_data(GTK_OBJECT(widget)));
//g_print("l_f1dfz1_v_knopka knop=%d\n",knop);
...
//g_print("l_f1dfz1_v_vvod enter=%d\n",enter);
