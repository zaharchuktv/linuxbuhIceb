/*$Id: l_prov_usl.c,v 1.33 2011-02-21 07:35:53 sasa Exp $*/
/*18.06.2010	03.11.2005	Белых А.И.	l_prov_usl.c
...
void       prov_usl_radio1(GtkWidget *,class prov_usl_data *);
void       prov_usl_radio2(GtkWidget *,class prov_usl_data *);
...
void  prov_usl_radio1(GtkWidget *widget,class prov_usl_data *data)
{
//g_print("prov_usl_radio1\n");
if(data->metka_r == 1)
  return;
data->metka_r=1;
prov_usl_create_list(data);
}
void  prov_usl_radio2(GtkWidget *widget,class prov_usl_data *data)
{
//g_print("prov_usl_radio1\n");
if(data->metka_r == 2)
  return;
