/*$Id: l_uslpodr_v.c,v 1.16 2011-02-21 07:35:54 sasa Exp $*/
/*03.08.2005	18.07.2005	Белых А.И.	l_uslpodr_v.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(l_uslpodr_v_v_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD]), "activate",GTK_SIGNAL_FUNC(l_uslpodr_v_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAIM]), "activate",GTK_SIGNAL_FUNC(l_uslpodr_v_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(l_uslpodr_v_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(l_uslpodr_v_v_knopka),&data);
...
//printf("l_uslpodr_v_v_key_press\n");
switch(event->keyval)
 {
...
//g_print("l_uslpodr_v_v_vvod enter=%d\n",enter);
