/*$Id: zar_snu_m.c,v 1.9 2011-02-21 07:35:59 sasa Exp $*/
/*30.11.2006	30.11.2006	Белых А.И.	zar_snu_m.c
  ...
  void read_rek()
   {
    ...
    rk->kolih_kol.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(entry[E_KOLIH_KOL]))));
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(zar_snu_m_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATAN]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATAN]), "activate",GTK_SIGNAL_FUNC(zar_snu_m_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATAK]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATAK]), "activate",GTK_SIGNAL_FUNC(zar_snu_m_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_TABNOM]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_TABNOM]), "activate",GTK_SIGNAL_FUNC(zar_snu_m_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KOD_NAH]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD_NAH]), "activate",GTK_SIGNAL_FUNC(zar_snu_m_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KOD_UD]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD_UD]), "activate",GTK_SIGNAL_FUNC(zar_snu_m_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_PODR]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_PODR]), "activate",GTK_SIGNAL_FUNC(zar_snu_m_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KOD_KAT]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOD_KAT]), "activate",GTK_SIGNAL_FUNC(zar_snu_m_vvod),&data);
...
data.entry[E_KOLIH_KOL] = gtk_entry_new_with_max_length (20);
gtk_box_pack_start (GTK_BOX (hbox[E_KOLIH_KOL]), data.entry[E_KOLIH_KOL],TRUE, TRUE, 0);
gtk_signal_connect(GTK_OBJECT (data.entry[E_KOLIH_KOL]), "activate",GTK_SIGNAL_FUNC(zar_snu_m_vvod),&data);
gtk_entry_set_text(GTK_ENTRY(data.entry[E_KOLIH_KOL]),data.rk->kolih_kol.ravno_toutf());
gtk_object_set_user_data(GTK_OBJECT(data.entry[E_KOLIH_KOL]),(gpointer)E_KOLIH_KOL);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(zar_snu_m_knopka),&data);
...
switch (enter)
 {
  ...
  case E_KOD_KAT:
    ...
    break;
  case E_KOLIH_KOL:
    data->rk->kolih_kol.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(widget))));
    break;
