/*$Id: l_uosmo_p.c,v 1.8 2011-02-21 07:35:54 sasa Exp $*/
/*18.10.2007	18.10.2007	Белых А.И.	l_uosmo_p.c
...
//g_print("l_uosmo_p_knopka knop=%d\n",knop);
...
//g_print("l_uosmo_p_vvod enter=%d\n",enter);
