/*$Id: l_usldoks_p.c,v 1.15 2011-02-21 07:35:54 sasa Exp $*/
/*19.09.2009	18.07.2005	Белых А.И.	l_usldoks_p.c
  ...
  void read_rek()
   {
    ...
    rpoi->dover.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(entry[E_DOVER]))));
    ...
    rpoi->kodop.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(entry[E_KODOP]))));
    rpoi->kontr.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(entry[E_KONTR]))));
    rpoi->kodpod.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(entry[E_KODPOD]))));
    rpoi->pr_ras.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(entry[E_PR_RAS]))));
    rpoi->naim_kontr.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(entry[E_NAIM_KONTR]))));
    rpoi->nalnak.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(entry[E_NALNAK]))));
/*****
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(usldoks_p_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NOMDOK]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATAN]),"clicked",GTK_SIGNAL_FUNC(usldoks_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATAN]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATAK]),"clicked",GTK_SIGNAL_FUNC(usldoks_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATAK]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KONTR]),"clicked",GTK_SIGNAL_FUNC(usldoks_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KONTR]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KODOP]),"clicked",GTK_SIGNAL_FUNC(usldoks_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KODOP]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KODPOD]),"clicked",GTK_SIGNAL_FUNC(usldoks_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KODPOD]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_PR_RAS]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NAIM_KONTR]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
gtk_entry_set_text(GTK_ENTRY(data.entry[E_NAIM_KONTR]),data.rpoi->naim_kontr.ravno_toutf());
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_NALNAK]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
gtk_entry_set_text(GTK_ENTRY(data.entry[E_NALNAK]),data.rpoi->nalnak.ravno_toutf());
gtk_object_set_user_data(GTK_OBJECT(data.entry[E_NALNAK]),(gpointer)E_NALNAK);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DOVER]), "activate",GTK_SIGNAL_FUNC(usldoks_p_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(usldoks_p_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]),"clicked",GTK_SIGNAL_FUNC(usldoks_p_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(usldoks_p_knopka),&data);
...
//g_print("usldoks_p_vvod enter=%d\n",enter);
...
switch (enter)
 {
  ...
  case E_NAIM_KONTR:
    data->rpoi->naim_kontr.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(widget))));
    break;

  case E_NALNAK:
    data->rpoi->nalnak.new_plus(iceb_u_fromutf((char*)gtk_entry_get_text(GTK_ENTRY(widget))));
    break;
