/*$Id: uosvamotw_m.c,v 1.8 2011-02-21 07:35:58 sasa Exp $*/
/*30.01.2008	28.12.2007	Белых А.И.	uosvamotw_m.c
...
gboolean   uosvamotw_v_key_press(GtkWidget *widget,GdkEventKey *event,class uosvamotw_m_data *data);
void    uosvamotw_v_vvod(GtkWidget *widget,class uosvamotw_m_data *data);
void  uosvamotw_v_knopka(GtkWidget *widget,class uosvamotw_m_data *data);
void  uosvamotw_v_e_knopka(GtkWidget *widget,class uosvamotw_m_data *data);

int uosvamotw_m_provr(class uosvamotw_m_data *data);
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(uosvamotw_v_key_press),&data);

GtkWidget *label=NULL;
label=gtk_label_new(gettext("Распечатка ведомости аморт-отчислений для налогового учёта"));//2
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_MESN]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_MESK]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_GOD]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_GRUPA]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_GRUPA]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_MAT_OT]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_MAT_OT]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_PODR]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_PODR]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_SHETU]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_SHETU]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_HAU]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_HAU]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_INNOM]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_INNOM]), "activate",GTK_SIGNAL_FUNC(uosvamotw_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(uosvamotw_v_knopka),&data);
...
/*g_print("uosvamotw_v_e_knopka knop=%d\n",knop);*/
...
//g_print("uosvamotw_v_vvod enter=%d\n",enter);
