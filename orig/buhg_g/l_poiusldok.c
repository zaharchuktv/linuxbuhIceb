/*$Id: l_poiusldok.c,v 1.15 2011-02-21 07:35:53 sasa Exp $*/
/*04.07.2005	05.11.2004	Белых А.И.	l_poiusldok.c
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(poiusldok_key_press),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]), "clicked",GTK_SIGNAL_FUNC(poiusldok_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]), "clicked",GTK_SIGNAL_FUNC(poiusldok_knopka),&data);
