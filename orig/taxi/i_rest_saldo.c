/*$Id: i_rest_saldo.c,v 1.18 2011-02-21 07:36:20 sasa Exp $*/
/*05.06.2008	26.12.2004	Белых А.И.	i_rest_saldo.c
...
gtk_signal_connect(GTK_OBJECT(data.window),"delete_event",GTK_SIGNAL_FUNC(i_rest_saldo_destroy),&data.knopka);
...
gtk_signal_connect(GTK_OBJECT(knopka[SALDO]),"clicked",GTK_SIGNAL_FUNC(i_rest_saldo_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(knopka[DELETE]),"clicked",GTK_SIGNAL_FUNC(i_rest_saldo_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(knopka[RAB_S_F_N]),"clicked",GTK_SIGNAL_FUNC(i_rest_saldo_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(knopka[VIHOD]),"clicked",GTK_SIGNAL_FUNC(i_rest_saldo_knopka),&data);
