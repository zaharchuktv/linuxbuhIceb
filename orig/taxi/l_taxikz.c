/*$Id: l_taxikz.c,v 1.6 2011-02-21 07:36:20 sasa Exp $*/
/*30.05.2009	30.05.2009	Белых А.И.	l_taxikz.c
...
sprintf(bros,"%s %s",name_system,iceb_u_toutf("Список кодов завершения"));
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(l_taxikz_key_press),&data);
...
data.label_kolstr=gtk_label_new (iceb_u_toutf("Список кодов завершения"));
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]), "clicked",GTK_SIGNAL_FUNC(l_taxikz_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[SFK2]), "clicked",GTK_SIGNAL_FUNC(l_taxikz_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK3]), "clicked",GTK_SIGNAL_FUNC(l_taxikz_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[SFK3]), "clicked",GTK_SIGNAL_FUNC(l_taxikz_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]), "clicked",GTK_SIGNAL_FUNC(l_taxikz_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK5]), "clicked",GTK_SIGNAL_FUNC(l_taxikz_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]), "clicked",GTK_SIGNAL_FUNC(l_taxikz_knopka),&data);
...
iceb_u_zagolov("Список кодов завершения",0,0,0,0,0,0,organ,ff);
