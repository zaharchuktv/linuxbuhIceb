...
#include "../knopki/logo.xpm"
#include "../knopki/flag.xpm"
enum
 {
  SMENABAZ,
  VIHOD,
...
pixmap=gdk_pixmap_create_from_xpm_d(data.window->window,&mask,&style->bg[GTK_STATE_NORMAL],(gchar **)logo_xpm);
...
pixmap=gdk_pixmap_create_from_xpm_d(data.window->window,&mask,&style->bg[GTK_STATE_NORMAL],(gchar **)flag_xpm);
pixmapWidget=gtk_pixmap_new(pixmap,mask);
