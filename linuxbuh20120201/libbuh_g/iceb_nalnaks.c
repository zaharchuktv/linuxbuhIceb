...
//      break;
    ...
    case 6: /*Дата выписки - номер счет-фактуры*/
      sprintf(strsql,"%*s",iceb_u_kolbait(7,nomnn),nomnn);
      iceb_u_bstab(stroka,strsql,70,78,1);
      iceb_u_bstab(stroka,data_vipiski,88,160,1);
      break;
...
//      break;
    ...
    case 10: /*строка наименования продавца*/
      iceb_u_bstab(stroka,nmo,10,116,1);
      break;

    case 12: /*адрес продавца*/
      iceb_u_bstab(stroka,gor,16,116,1);
      break;

    case 14: /*инн кпп продавца*/
      iceb_u_bstab(stroka,inn,20,116,1);
      break;            

    case 16: /*наименование и адрес грузоотправителя*/
        memset(strsql,'\0',sizeof(strsql));
        sprintf(strsql,"%s %s",nmo,gor);
        iceb_u_bstab(stroka,strsql,30,116,1);
      break;

    case 18: /*наименование и адрес грузополучателя*/
        memset(strsql,'\0',sizeof(strsql));
        sprintf(strsql,"%s %s",nmo1,gor1);
        iceb_u_bstab(stroka,strsql,30,116,1);
      break;

   case 22: /*строка наименования покупателя*/
      iceb_u_bstab(stroka,nmo1,12,116,1);
      break;

    case 24: /*адрес покупателя*/
      iceb_u_bstab(stroka,gor1,18,116,1);
      break;

    case 26: /*инн кпп покупателя*/
      iceb_u_bstab(stroka,inn1,22,116,1);
      break;            
