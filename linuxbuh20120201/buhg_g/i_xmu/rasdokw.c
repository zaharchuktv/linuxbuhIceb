...
*/
  if(tipz == 2)
   ...
   fprintf(f1,"                                                                      |      код     |\n");
   fprintf(f1,"                                                                      ----------------\n");
   fprintf(f1,"                                                        Форма по ОКУД |    0330212   |\n");
   fprintf(f1,"                                                                      ----------------\n");

  fprintf(f1,"%s %s %s %s\n",nmo,gor,tel,nsh);
   fprintf(f1,"______________________________________________________________по ОКПО |             |\n");


/* 
memset(bros,'\0',sizeof(bros));
memset(bros1,'\0',sizeof(bros1));
memset(bros2,'\0',sizeof(bros2));
memset(bros3,'\0',sizeof(bros3));
sprintf(bros,"%s",nmo);
sprintf(bros1,"%s",gor);
sprintf(bros2,"%s",tel);
sprintf(bros3,"%s",nsh);
...
fprintf(f1,"%-*.*s %-*.*s %-*.*s %-*.*s\n",iceb_u_kolbait(40,bros),iceb_u_kolbait(40,bros),bros,iceb_u_kolbait(40,bros1),iceb_u_kolbait(40,bros1),bros1,iceb_u_kolbait(40,bros2),iceb_u_kolbait(40,bros2),bros2,iceb_u_kolbait(40,bros3),iceb_u_kolbait(40,bros3),bros3);

  if(iceb_u_strlen(bros) > 40 || iceb_u_strlen(bros1) > 40 || iceb_u_strlen(bros2) > 40 || iceb_u_strlen(bros3) > 40)
   fprintf(f1,"%-*.*s %-*.*s %-*.*s %-*.*s\n",
   ...
   iceb_u_kolbait(40,iceb_u_adrsimv(40,bros2)),
   iceb_u_kolbait(40,iceb_u_adrsimv(40,bros2)),
   iceb_u_adrsimv(40,bros2),
   iceb_u_kolbait(40,iceb_u_adrsimv(40,bros3)),
   iceb_u_kolbait(40,iceb_u_adrsimv(40,bros3)),
   iceb_u_adrsimv(40,bros3));
*/
...
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\n");
  ...
  fprintf(f1,gettext("   |                    |              (товара)                        |изм.|          |кол. |           |          |\n"));
