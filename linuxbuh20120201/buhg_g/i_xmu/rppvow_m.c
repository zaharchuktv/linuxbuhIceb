/*$Id: rppvow_m.c,v 1.12 2011-02-21 07:35:57 sasa Exp $*/
/*23.12.2005	07.04.2005	Белых А.И.	rppvow_m.c
Меню для расчёта реестра проводок по видам операций
*/
#include <stdlib.h>
...
void       rppvow_radio0(GtkWidget *,class rppvow_data *);
void       rppvow_radio1(GtkWidget *,class rppvow_data *);
void       rppvow_radio2(GtkWidget *,class rppvow_data *);

gboolean   rppvow_v_key_press(GtkWidget *widget,GdkEventKey *event,class rppvow_data *data);
void    rppvow_v_vvod(GtkWidget *widget,class rppvow_data *data);
void  rppvow_v_knopka(GtkWidget *widget,class rppvow_data *data);
void  rppvow_v_e_knopka(GtkWidget *widget,class rppvow_data *data);
...
gtk_signal_connect_after(GTK_OBJECT(data.window),"key_press_event",GTK_SIGNAL_FUNC(rppvow_v_key_press),&data);

GtkWidget *label=gtk_label_new(gettext("Распечатать реестр проводок по видам операций"));
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton[0]), "clicked",GTK_SIGNAL_FUNC(rppvow_radio0),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton[1]), "clicked",GTK_SIGNAL_FUNC(rppvow_radio1),&data);
...
gtk_signal_connect(GTK_OBJECT(data.radiobutton[2]), "clicked",GTK_SIGNAL_FUNC(rppvow_radio2),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATAN]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATAN]), "activate",GTK_SIGNAL_FUNC(rppvow_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_DATAK]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_DATAK]), "activate",GTK_SIGNAL_FUNC(rppvow_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KODOP]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KODOP]), "activate",GTK_SIGNAL_FUNC(rppvow_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_KONTR]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_KONTR]), "activate",GTK_SIGNAL_FUNC(rppvow_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_SKLAD]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_SKLAD]), "activate",GTK_SIGNAL_FUNC(rppvow_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka_enter[E_SHET]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_e_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT (data.entry[E_SHET]), "activate",GTK_SIGNAL_FUNC(rppvow_v_vvod),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK2]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK4]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_knopka),&data);
...
gtk_signal_connect(GTK_OBJECT(data.knopka[FK10]),"clicked",GTK_SIGNAL_FUNC(rppvow_v_knopka),&data);
...
void  rppvow_radio0(GtkWidget *widget,class rppvow_data *data)
{
//g_print("rppvow_radio0\n");
...
void  rppvow_radio1(GtkWidget *widget,class rppvow_data *data)
{
//g_print("rppvow_radio1\n");
if(data->rk->pr_ras == 1)
  return;
data->rk->pr_ras=1;
}
void  rppvow_radio2(GtkWidget *widget,class rppvow_data *data)
{
//g_print("rppvow_radio1\n");
if(data->rk->pr_ras == 2)
  return;
