...
class uosvhd_data
 {
  public:
    ...
    class iceb_u_str nomnalnak_z; //Номер счет-фактуры запомненный
    ...
    class iceb_u_str nomnalnak; //Номер счет-фактуры
    class iceb_u_str data_vnn;  //Дата выдачи/получения счет-фактуры
    class iceb_u_str data_opl;  //Дата оплаты
    class iceb_u_str forop;     //код формы оплаты
    class iceb_u_str dvnn; /*Дата выдачи счет-фактуры*/
